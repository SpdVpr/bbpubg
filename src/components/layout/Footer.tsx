            ...
            <div className="container mx-auto px-4">
                <div className="grid md:grid-cols-4 gap-8 mb-12">
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <div className="flex gap-4">
                            <a href="#" className="p-2 bg-slate-900 text-slate-400 hover:text-amber-500 hover:bg-slate-800 rounded-sm transition-colors border border-slate-800">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li><Link href="/armory" className="text-slate-400 hover:text-amber-500 text-sm">Weapon Database</Link></li>
                            <li><Link href="/intel" className="text-slate-400 hover:text-amber-500 text-sm">Map Leaks</Link></li>
                            <li><Link href="/news" className="text-slate-400 hover:text-amber-500 text-sm">Latest News</Link></li>
                            <li><Link href="/guides" className="text-slate-400 hover:text-amber-500 text-sm">Extraction Guides</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li><Link href="/about" className="text-slate-400 hover:text-amber-500 text-sm">About Us</Link></li>
                            <li><Link href="/privacy" className="text-slate-400 hover:text-amber-500 text-sm">Privacy Policy</Link></li>
                            <li><Link href="/terms" className="text-slate-400 hover:text-amber-500 text-sm">Terms of Service</Link></li>
                            <li><Link href="/contact" className="text-slate-400 hover:text-amber-500 text-sm">Contact</Link></li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="border-t border-slate-900 pt-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    ...
                    <div className="flex items-start gap-3 bg-slate-900/50 p-4 rounded border border-slate-800/50 max-w-xl">
                        <AlertTriangle className="w-5 h-5 text-amber-500/50 shrink-0 mt-0.5" />
